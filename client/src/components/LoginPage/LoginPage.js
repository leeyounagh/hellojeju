...
const LoginPage = (props) => {
   ...
   const NaviGate = useNavigate();
    ...
    return (
        <div className='login_background' style={{
            ...
            onSubmit={onSubmitHandler} netlify>
               ...
               height:"20px",borderRadius:"50px",
               top:"30px"}} type="email" value={Email} onChange={onEmailHandler}/>
                <label style={{zIndex:"100",
               position:"relative",left:"-20px",top:"30px"}}>Password</label>
                <input style={{zIndex:"100",
               position:"relative",left:"-10px",
               height:"20px",borderRadius:"50px",
               top:"30px"}} type="password" value={Password} onChange={onPasswordHandler}/>
                <br/>
                <button style={{zIndex:"100",
               position:"relative",left:"55px",top:"20px",width:"50px",
               borderRadius:"30px",background:"white"}} type='submit'>
                    login
                </button>
            </form>

            <div style={{position:"relative",
        top:"-100px",left:"-100px"}}className="login_body"id="snotomax">
                <div id="shakeHead">
                <div id="snoHead"></div>
                ...
                <div id="leftWhiskers">
                {/* <div class="whisk1"></div>
                <div class="whisk2"></div>
                <div class="whisk3"></div> */}
                </div>
                <div id="rightWhiskers">
                {/* <div class="whisk4"></div>
                <div class="whisk5"></div>
                <div class="whisk6"></div> */}
                </div>
                <div id="eyes">
